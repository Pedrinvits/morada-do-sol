        ...
        <section className="container gap-4 flex flex-col">
            ...
            <div className="w-full flex flex-col gap-4 md:flex-row items-center justify-center">
                <div className="imagem w-full sm:w-1/2 flex items-center justify-center ">
                    <Image width={0} height={0} className="w-1/2 h-[40%] self-center" alt="propolis" src={Propolis} />
                </div>
                <div className="px-5 flex flex-col gap-6 py-6 w-full sm:w-[40%] rounded-2xl border-2 border-gray-100 bg-white shadow-2xl">
                <Badge variant="secondary" className="bg-orange-500 text-white w-[60px]">-30%</Badge>
                    <div className="infos flex flex-col">
                        <h1 className="text-orange-500 text-xl font-bold">Própolis</h1>
                        <p className="text-sm text-gray-600">Própolis Natural</p>
                    </div>
                    <div className="flex gap-2">
                        <p className="text-xs font-bold"><s>R$ 50,00</s></p>
                        <p className="text-xl font-bold text-orange-500">R$ 35,00</p>
                    </div>
            ...
            <div className="flex flex-col p-4 mt-4">
                ...
                <p className="text-sm text-gray-600">Produto natural coletado pelas abelhas, é uma resina que é utilizada para selar e proteger a colméia. A própolis contém uma variedade de antioxidantes, incluindo flavonóides, que são grandes contribuintes a trazer benefícios à saúde.Auxiliando seu sistema Imunológico de forma natural e estimulando seu organismo a combater uma variedade de processos indesejados</p>
            </div>
