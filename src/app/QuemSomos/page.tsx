const QuemSomos = () => {
    return ( 
        <section className="container bg-[#ffde59] p-6 rounded-lg  sm:w-[80%] w-[80%] md:w-[80%]">
            <h1 className="text-xl sm:text-3xl text-orange-500 font-bold mb-4">Nossa Empresa</h1>
           ...
           <span className="text-green-700">Rigorosa Análise de Qualidade</span> Cada lote passa por análises rigorosas para garantir que apenas o mel mais puro e saboroso chegue à sua mesa. Transparência é a nossa promessa.<br/>

            Pureza que Encanta Sem melaço e sem açúcar - apenas o autêntico néctar das flores silvestres, proporcionando uma experiência de sabor incomparável.

            Deguste a Diversidade: Permita que seu paladar viaje por uma sinfonia de sabores, desde as delicadas notas florais até os robustos aromas da natureza intocada.

            Explore a autenticidade, descubra a diferença. 
           </p>
        </section>
     );
}
